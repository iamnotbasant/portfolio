...
const PlaylistProfile = () => {
  ...
  const getDifficultyBadge = (difficulty) => {
    switch (difficulty) {
      case "EASY":
        return <span className=" badge-success">Easy</span>;
      case "MEDIUM":
        return <span className=" badge-warning">Medium</span>;
      case "HARD":
        return <span className=" badge-error">Hard</span>;
      default:
        ...
        {playlists.length === 0 ? (
          ...
          <div className="space-y-6">
            {playlists.map((playlist) => (
              <div key={playlist.id} className=" bg-base-100 shadow-xl">
                                    ...
                                    <div className="flex flex-wrap gap-1">
                                      {item.problem.tags &&
                                        item.problem.tags.map((tag, idx) => (
                                          <div
                                            key={idx}
                                            className=" badge-outline badge-sm"
                                          >
